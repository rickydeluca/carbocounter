...
from models.SVM.svm import svm_pipeline
from datasets.food101 import load_food101
...
# Define model
pipeline = svm_pipeline(kernel='rbf')
...
dump(best_svm_model, 'trained_params/svm.joblib')
